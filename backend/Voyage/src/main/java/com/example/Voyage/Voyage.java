...
public class Voyage {
	...
	private ArrayList<Long> idvoyageur = new ArrayList<Long>();
	...
	public ArrayList<Long> getIdvoyageur() {
		return idvoyageur;
	}

	public void setIdvoyageur(ArrayList<Long> idvoyageur) {
	...
	public String toString() {
		return "Voyage [id=" + id + ", ville_depart=" + ville_depart + ", ville_arrive=" + ville_arrive
				...
				+ idconducteur + ", idvoyageur=" + idvoyageur + "]";
	}
